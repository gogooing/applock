...
import com.sanqiu.loro.applocktest.app.AppLockAPP;
...
public class SharePrefUtil {
    ...
    public static final String SYSTIME = "sys_time";
    static Context sContext = AppLockAPP.getContext();
    ...
    public static void putLongPersist(String key, long value) {
        SharedPreferences.Editor editor = sSettings.edit();
        editor.putLong(key, value);
        editor.apply();
    }

    public static long getLongPersist(String key, long def) {
        return sSettings.getLong(key, def);
    }

    public static void putFloatPersist(String key, float value) {
        SharedPreferences.Editor editor = sSettings.edit();
        editor.putFloat(key, value);
        editor.apply();
    }

    public static float getFloatPersist(String key, float def) {
        return sSettings.getFloat(key, def);
    }
