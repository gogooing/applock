...
import com.sanqiu.loro.applocktest.utils.VersionUtils;
...
public final class ThreadManager {
    ...
    /**
     * RTC的默认线程池Executor. 负责语音通话的线程
     */
    public static final Executor RTC_EXECUTOR;
    ...
    private static Executor initRtcExecutor() {
        return Executors.newSingleThreadExecutor();
    }

    public static void executeOnRtcThread(Runnable run) {
        RTC_EXECUTOR.execute(run);
    }
